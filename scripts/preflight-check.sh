...
require_text '官方 --force 可能因残缺任务定义拒绝' install-windows.ps1
require_text '已删除残缺任务并由官方命令重建 Gateway 启动器' install-windows.ps1
...
require_text 'Repair-MissingGatewayTask' install-windows.ps1
